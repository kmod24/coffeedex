...
struct ATierView: View {
    // Unique key for ATierView
    @AppStorage("aTierCoffeeViews") private var coffeeViewsData: Data = Data()
...
struct ATierView_Previews: PreviewProvider {
