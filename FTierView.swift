...
struct FTierView: View {
    // Unique key for FTierView
    @AppStorage("fTierCoffeeViews") private var coffeeViewsData: Data = Data()
...
struct FTierView_Previews: PreviewProvider {
