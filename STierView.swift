...
struct STierView: View {
    // Unique key for STierView
    @AppStorage("sTierCoffeeViews") private var coffeeViewsData: Data = Data()
...
struct STierView_Previews: PreviewProvider {
